### 1. Run this network.  (Links to an external site.)Links to an external site. After training the network, whatever accuracy you get is your base accuracy. Epochs = 100
